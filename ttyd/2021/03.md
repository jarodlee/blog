...
刚看到一个解决访问群晖端口的办法:https://www.mfpad.com/blog/qunhui-nas-access-without-port 
看上去,国内苦墙久矣,各种曲线救国呀,这个方法其实已经可以在域名面板直接配置的,没想到现在居然还有专门的公司做这个,只是这个似乎是政策灰色地带,很容易会被封杀的.
