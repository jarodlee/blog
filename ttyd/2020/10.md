...
## 28号
整理资料时发现一个非常牛X的软件，可以快速的查看网络使用情况，直观又高效，这就是[德国程序员开发的cFos](https://www.cfos.de/zh-cn/index.htm)，电脑中保存的是08年华硕主板赠送的注册版，可能是版本太旧了，，开启LED灯效果时会影响SHIFT键的使用。最让我惊讶的是，这么多年了，这个软件的维护工作还在进行着，新版也提供了对中国用户的销售与贡献赠送注册码的功能！这在整理时发现很多软件已经停止更新的时候真是太惊讶了！！
