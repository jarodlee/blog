...
看到github的一些有趣工具:https://shields.io/ 出处是[知乎的专栏](https://zhuanlan.zhihu.com/p/283447572)

还一个很厉害的在线js/html编辑器:https://stackblitz.com/fork/js

## 22号
看到了在线搭建scratch的方案,好像只要用npm就可以很快搭出来的.https://github.com/ghtxx/scratch-gui

## 24号
什么都会被封，狂想鸡尾酒 配方：https://interactive.zaobao.com/christmas-cocktails/index.html

这个是在windows上使用github的一个例子：https://spoience.com/hexo-github-build.html

## 25号
看到一个新的工具,很酷,回头可以把机房所有机器远程管理起来了:https://www.zerotier.com/download/
...
换个画,创意无限:http://www.sketchswap.com/

一亿像素,超清晰:https://www.sigoo.com/

迷宫生成器:http://www.mazegenerator.net/

一个很干净的超强导航:http://guozhivip.com/
...
## 30号
整理了一下2020学年的教育部竞赛目录小学部分:https://i.ghtxx.cn/2020-jinsai.htm
